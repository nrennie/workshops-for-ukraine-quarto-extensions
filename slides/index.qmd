...
See [quarto.org/docs/output-formats/ms-word-templates.html](https://quarto.org/docs/output-formats/ms-word-templates.html) for all PDF options.
...
# Styling with Quarto extension {background-color="#D9DBDB"}
